 ...
 *
 * Created on November 6, 2024, 9:24PM
 * This program will have the same functionality as version 10.
 * The only difference is that the rules will be discussed before the game
 * begins
 */
