 ...
 *
 * Created on November 6, 2024, 6:49PM
 * In This Program I will utilize a dealer object who will act as a player as
 * as well as a dealer, along with three different player objects. This is b/c 
 * the game of Spades can only be played with four players at a time.
 * The objective of this program is to ensure that each player will have
 * his/her unique hand that is dealt accordingly to the shuffled deck.
 * Each player will then be able to lay down one of his/her cards
 * I will also be allowing each player and dealer to input their own names
 */
